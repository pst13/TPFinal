...
namespace FormLaberinto
{
	...
	public class Cell
	{
        ...
        public bool entrada;//Marco Si la celda es entrada
        public bool salida;//Marco si la elda es salida 
...
//		public int queCamino(Cell actual){
////		public int queCamino(){
//			int con=0;
//			if(actual.visitada==false){
//				while(actual.Walls[con]!=0){
//					actual.visitada=true;
//					actual.CualEntrada=con;
//					
//					con++;
//				}
//			}else{
//				while(actual.Walls[con]!=0 & actual.CualEntrada==con){
//					
//					con++;
//				}
//			}
